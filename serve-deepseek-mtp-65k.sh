#!/usr/bin/env bash
# =============================================================================
# serve-deepseek-mtp-65k.sh -- fastest DeepSeek-V4-Flash: fit-in-VRAM + MTP
# =============================================================================
# Thin convenience wrapper around:  ./serve.sh deepseek-v4-flash-mtp
#
#   ./serve-deepseek-mtp-65k.sh              start at profile defaults (65536 ctx)
#   ./serve-deepseek-mtp-65k.sh --ctx 32768  lower context (more draft headroom)
#   ./serve-deepseek-mtp-65k.sh --port 9000  override the port
#   ./serve-deepseek-mtp-65k.sh --dry-run    print the command without running it
#
...
# ./serve-deepseek.sh but point it at the antirez model: ~69 tok/s at 128k, no
# MTP. The trade is real: 65k @ 87 tok/s vs 128k @ 69 tok/s.
#
# Two deliberate defaults (same as serve-deepseek.sh):
