...
and 52.9 at 129k, and Q8_0 to 30.8 at 76k; the before/after pairs are RESULTS
§52 and §52.2. **Caps differ by column and prefill follows the cap** (4–5 %,
§49.12): Q4 @128k ran at 500 W, Q8_0 @128k at 600 W, and the Q8_0 @256k column
is untouched from 2026-09-03. Generation is cap-insensitive on this model, so
those numbers compare across columns and prefill does not.
